  ...
  schema: {
    ...
    properties: {
      reactions: {
        ...
        'x-designable-id': 'e0d49h0hyp7',
        'x-index': 0,
        'x-validator': [],
        'x-decorator-props': {},
        items: {
          type: 'object',
          'x-designable-id': 'q3vbabhiaqn',
          'x-validator': [],
          properties: {
            yokw4w5dc85: {
              type: 'void',
              'x-component': 'ArrayCards.Index',
              'x-designable-id': 'yokw4w5dc85',
              'x-index': 0,
            },
            type: {
              type: 'string | number',
                    ...
                    catalyst: {
                      ...
                      properties: {
                        name: {
                          ...
                          'x-component-props': {
                            placeholder:
                              'eg: palladium on carbon  / Pd(OAc)2   /  ZSM-5',
                          },
                          'x-decorator-props': {},
                        ...
                        shape: {
                          ...
                          'x-component-props': {
                            placeholder:
                              'eg: spherical / nanosheets / core-shell',
                          },
                          'x-decorator-props': {},
                          name: 'shape',
                        ...
                        preparationMethod: {
                          ...
                          'x-component-props': {
                            placeholder:
                              'eg: incipient wetness impregnation /  electrochemical deposition / sol–gel method',
                          },
                          'x-decorator-props': {},
                        ...
                        udal3vfymn5: {
                          ...
                          properties: {
                            acidityAndBasicity: {
                              ...
                              'x-component-props': {
                                placeholder:
                                  'eg: ZnGaOx_NP exhibits Lewis acidity due to coordinatively unsaturated Ga3+ sites',
                              },
                              'x-decorator-props': {},
                        ...
                        '1td82j11hqo': {
                          ...
                          properties: {
                            lightSource: {
                              ...
                              'x-component-props': {
                                placeholder:
                                  'eg: UV light, 100 mW/cm² / blue LEDs / visible light',
                              },
                              'x-decorator-props': {},
                              name: 'lightSource',
                            ...
                            lightWavelength: {
                              ...
                              'x-component-props': {
                                placeholder:
                                  'eg: >450 nm / visible light / 440–460 nm',
                              },
                              'x-decorator-props': {},
                        ...
                        n7wp5s6264u: {
                          ...
                          properties: {
                            electrodeMaterial: {
                              ...
                              'x-component-props': {
                                placeholder:
                                  'eg: Bi2S3-derived nanocomposite / glassy carbon',
                              },
                              'x-decorator-props': {},
                            ...
                            appliedPotential: {
                              ...
                              'x-component-props': {
                                placeholder:
                                  'eg: 1.6 V / -1.2 V vs. NHE / 2.1 V vs SHE',
                              },
                              'x-decorator-props': {},
                            ...
                            referenceElectrode: {
                              ...
                              'x-component-props': {
                                placeholder:
                                  'eg: Reversible Hydrogen Electrode (RHE) / Ag/AgCl (3 M KCl)',
                              },
                              'x-decorator-props': {},
                            ...
                            counterElectrode: {
                              ...
                              'x-component-props': {
                                placeholder:
                                  'eg: Pt wire / graphite rod / Pt / Pt mesh / graphite electrode',
                              },
                              'x-decorator-props': {},
                    ...
                    solvents: {
                      ...
                      properties: {
                        ...
                        pH: {
                          ...
                          'x-component-props': {
                            placeholder:
                              'eg: 1.3  / neutral / 7.2–7.4 / 13.00 ± 0.01 / <1',
                          },
                          'x-decorator-props': {},
                          name: 'pH',
                              ...
                              wsmrtk9iuig: {
                                ...
                                properties: {
                                  yield: {
                                    ...
                                    'x-component-props': {
                                      placeholder:
                                        'eg: 91.5 % / >99% / above 99% / near-quantitativ',
                                    },
                                    'x-decorator-props': {},
                                    name: 'yield',
                              ...
                              mm4npc74xrw: {
                                ...
                                properties: {
                                  selectivity: {
                                    ...
                                    'x-component-props': {
                                      placeholder:
                                        'eg: 98 % / >99% / near 100% / negligible / trace amounts',
                                    },
                                    'x-decorator-props': {},
                                    name: 'selectivity',
        ...
        properties: {
          nfw3safyyyk: {
            ...
            'x-component-props': {},
            'x-designable-id': 'nfw3safyyyk',
            'x-index': 0,
          },
        },
      },
    },
    'x-designable-id': '9f3k7ghvp8c',
  },
};
