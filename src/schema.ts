                ...
                properties: {
                  productions: {
                    ...
                    "x-decorator-props": {
                      ...
                      labelWrap: false,
                      tooltip:
                        "Name：具体命名或称谓或代号.产物和产率、选择性、法拉第效率需要一一对应；  Yield：数字+单位  ,或其他可定量的描述；  Selectivity：数字+单位  ,或其他可定量的描述；  Faradaic Efficiency：数字+单位  ,或其他可定量的描述。",
                    },
                            ...
                            faradaicEfficiency: {
                              ...
                              "x-reactions": {
                                ...
                                fulfill: {
                                  state: {
                                    pattern:
                                      "{{$deps.type === 'electorcatalysis' ? 'editable' : 'disabled'}}",
                                  },
                                },
                              },
                            },
